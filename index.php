...
<html>
<head>
    <title>HVF Advocacia</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0">

    <meta name="description" content="Site de Advocacia, Direitos Trabalhistas">
 ...
 <header class="section page-header rd-navbar-transparent-wrap">
            ...
            <div class="rd-navbar-aside-outer rd-navbar-collapse">
              <div class="rd-navbar-aside">
                <div class="rd-navbar-info">
                  <div class="icon novi-icon mdi mdi-phone"></div><a href="http://api.whatsapp.com/send?1=pt_BR&phone=5531975275084" title=" Whatsapp 31 97527-5084">31 97527-5084</a>
                </div>
                <ul class="list-lined">
       ...
       <section class="section section-sm section-sm-bottom-100 bg-primary" id="servicos">
        <div class="container">
      ...
      <section class="section section-lg bg-default" id="sobre">
        <div class="container">
          <h2><span class="text-light">Sua</span> História</h2>
          <div class="row row-30 justify-content-xl-between">
            <div class="col-md-6 col-xl-6">
              ...
              <div class="box-shadow-2">
                ...
                </div><img class="img-responsive" src="img/escritorio.jpg" alt="Veja nosso Escritório" width="569" height="169"/>
              </div>
            </div>
            <div class="col-md-6 col-xl-5">
              <ul class="list-lg">
                ...
                <li><a class="button button-primary" href="http://google.com" target="_blank">Nossa Página</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section class="section section-lg bg-gray-100">
        <div class="container text-center text-lg-left">
          <h2><span class="text-light">Nossos</span> Príncipios</h2>
      ...
      <section class="section section-lg bg-gray-800" id="clientes">
        <div class="container text-center text-xl-left">
          <h2>Nossos <span class="text-light">Clientes</span></h2>
          <div class="owl-carousel owl-carousel-4 text-center" data-items="1" data-sm-items="3" data-md-items="4" data-lg-items="5" data-xl-items="6" data-dots="true" data-nav="false" data-stage-padding="15" data-loop="false" data-margin="30" data-mouse-drag="false">
            <div class="item"><a class="link-image" ><img src="img/profiles/cliente2.webp" alt="" width="150" height="35"/></a>
                <p>"Fiquei muito satisfeito com tudo que essa equipe maravilhosa fez por mim, atendeu muito bem minhas espectativas!!"</div>
        ...
        <div class="container text-center text-lg-left">
          ...
          <div class="row row-40">
            <div class="col-md-4">
              <div class="team-box-left">
                <div class="team-meta unit align-items-center">
                  <div class="unit-left"><img class="img" src="img/profiles/cliente.jpg" alt="" width="138" height="69"/>
                  </div>
                  <div class="unit-body">
                    <h5 class="title">Kate White</h5>
                    <div class="subtitle">Direito Trabalhista</div>
                  </div>
                </div>
                <div class="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam a fermentum turpis. Nulla metus diam, feugiat ac lectus vitae, tempus porttitor sem. Vestibulum non lacus vulputate, placerat ligula ut, dignissim tortor.</div>
              </div>
            ...
            <div class="col-md-4">
              <div class="team-box-left">
                <div class="team-meta unit align-items-center">
                  <div class="unit-left"><img class="img" src="img/profiles/cliente1.png" alt="" width="138" height="69"/>
                  </div>
                  <div class="unit-body">
                    <h5 class="title">Elen Jackson</h5>
            ...
            <div class="col-md-4">
              <div class="team-box-left">
                <div class="team-meta unit align-items-center">
                  <div class="unit-left"><img class="img" src="img/profiles/cliente2.webp" alt="" width="138" height="69"/>
                  </div>
                  <div class="unit-body">
          ...
          </div><a class="button button-primary" href="#">Ver Todos</a>
        </div>
      </section>
          ...
          <form action="enviar.php" method="post" id="contactForm" name="sentMessage">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <input class="form-control" id="telefone" name="telefone" type="tel" placeholder="Seu Telefone - Opcional">
   ...
   <footer class="section footer-classic">
        ...
        <div class="col-md-6" align="center">
          <ul class="list-inline social-buttons">
            ...
            <li class="list-inline-item">
              <a href="https://www.facebook.com/profile.php?id=100094879613995" target="_blank" title="Nossa Página no Facebbok">
                <i class="fab fa-facebook-f"></i>
              </a>
            </li>
            <li class="list-inline-item">
               <a href="https://www.instagram.com/?next=%2F" target="_blank" title="Nosso Instragram">
        ...
        <div class="col-md-3" align="center">
          <ul class="list-inline">
            ...
            <li class="list-inline-item">
              Paulo Roberto - <a class="text-muted" href="http://api.whatsapp.com/send?1=pt_BR&phone=5531975275084" alt="31 97527-5084" target="_blank"><i class="fab fa-whatsapp mr-1"></i>22 99872-4205</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="footer-inner-2">
          <div class="container">
            <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span>. Todos os Direitos Reservados. Desenvolvido por <a href="https://www.pauloroberto.com.br">Paulo Roberto</a></p>
          </div>
        </div>
      </footer>
